...
- [Ana Gövde: Kronolojik veya Tematik Kayıt](#ana-gövde-kronolojik-veya-tematik-kayıt)
  - [LABORATUVAR ÇALIŞMA KURALLARI](#laboratuvar-çalişma-kurallari)
  - [Deney 1. Temel Elektrik Devrelerinin Kurulumu](#deney-1-temel-elektrik-devrelerinin-kurulumu)
    - [Teorik Bilgi: Elektrik Devresi](#teorik-bilgi-elektrik-devresi)
      - [Pratik çalışma 1: Doğru akım devresi kurmak](#pratik-çalışma-1-doğru-akım-devresi-kurmak)
    - [Pratik çalışma 2: İletkenin cinsi ve boyutlarına göre direncinin değişimini incelemek](#pratik-çalışma-2-i̇letkenin-cinsi-ve-boyutlarına-göre-direncinin-değişimini-incelemek)
    - [Pratik çalışma 3: Galvanometre yapısı ve Direnç Ölçmek](#pratik-çalışma-3-galvanometre-yapısı-ve-direnç-ölçmek)
      - [DENEYİN YAPILIŞI:](#deneyi̇n-yapilişi)
    - [Pratik çalışma 4: Analog Ampermetre ve Voltmetre Yapısı, DC Akım ve Gerilimin ölçülmesi.](#pratik-çalışma-4-analog-ampermetre-ve-voltmetre-yapısı-dc-akım-ve-gerilimin-ölçülmesi)
      - [Deneyin Yapılışı](#deneyin-yapılışı)
    - [Pratik çalışma 5: Alternatif Akımda (AC) AKIM VE GERILIMIN ÖLÇÜLMESi](#pratik-çalışma-5-alternatif-akımda-ac-akim-ve-gerilimin-ölçülmesi)
      - [DENEYİN YAPILIŞI:](#deneyi̇n-yapilişi-1)
    - [Pratik çalışma 5: Sigorta telinin incelenmesi](#pratik-çalışma-5-sigorta-telinin-incelenmesi)
      - [Deneyin Yapılışı](#deneyin-yapılışı-1)
  - [Deney 2. Devre doğrudan ve dolaylı ölçümler yoluyla Akım, Voltaj, Direnç ve Güç değerlerinin Ölçülmesi ve hata hesabı](#deney-2-devre-doğrudan-ve-dolaylı-ölçümler-yoluyla-akım-voltaj-direnç-ve-güç-değerlerinin-ölçülmesi-ve-hata-hesabı)
    - [Ön Bilgi](#ön-bilgi)
      - [Hataların bileşkesi](#hataların-bileşkesi)
    - [Akım Ve Gerilim Ölçme](#akım-ve-gerilim-ölçme)
      - [Deneyin Yapılışı (1. Bölüm)](#deneyin-yapılışı-1-bölüm)
    - [Güç Ölçme (Ampermetre ve Voltmetre ile)](#güç-ölçme-ampermetre-ve-voltmetre-ile)
      - [Deneyin Yapılışı (2. Bölüm)](#deneyin-yapılışı-2-bölüm)
    - [Direnç Ölçme](#direnç-ölçme)
    - [Ampermetre-Voltmetre Yöntemi ile Direnç Ölçmek](#ampermetre-voltmetre-yöntemi-ile-direnç-ölçmek)
      - [Deneyin Yapılışı (3. Bölüm)](#deneyin-yapılışı-3-bölüm)
    - [Wheatstone Köprü Devresi ile Direnç Ölçmek](#wheatstone-köprü-devresi-ile-direnç-ölçmek)
      - [Deneyin Yapılışı (4. Bölüm)](#deneyin-yapılışı-4-bölüm)
  - [Deney 3: Alternatif akımda Akım, Gerilim, Güç, Cosф ve Enerji Ölçümü](#deney-3-alternatif-akımda-akım-gerilim-güç-cosф-ve-enerji-ölçümü)
    - [Akım, Gerilim, Güç, Cosф ve Enerji Ölçümü Ön Bilgi](#akım-gerilim-güç-cosф-ve-enerji-ölçümü-ön-bilgi)
    - [Alternatif Akımda Ani, Ortalama, Maksimum ve Etkin Değerler](#alternatif-akımda-ani-ortalama-maksimum-ve-etkin-değerler)
    - [Alternatif akımda Güç Ve Enerji](#alternatif-akımda-güç-ve-enerji)
    - [Wattmetre ve Cosφmetre](#wattmetre-ve-cosφmetre)
    - [Deney Öncesi çalışma:](#deney-öncesi-çalışma)
    - [Deney Çalışması:](#deney-çalışması)
      - [BÖLÜM-1: Alternatif akımda Güç Ölçmeleri](#bölüm-1-alternatif-akımda-güç-ölçmeleri)
      - [BÖLÜM 2: Alternatif akımda Faz farkı Ölçmeleri](#bölüm-2-alternatif-akımda-faz-farkı-ölçmeleri)
      - [BÖLÜM 3: Alternatif akımda Enerji Ölçmeleri](#bölüm-3-alternatif-akımda-enerji-ölçmeleri)
  - [DENEY No 4: Osiloskop ve Alternatif Akım Dalga Şekillerinin incelenmesi. Genlik, Frekans ve faz farkı Ölçümleri, Ortalama ve Etkin Değerler](#deney-no-4-osiloskop-ve-alternatif-akım-dalga-şekillerinin-incelenmesi-genlik-frekans-ve-faz-farkı-ölçümleri-ortalama-ve-etkin-değerler)
    - [Genel Bakış:](#genel-bakış)
    - [Ekran Görüntüleme Grubu](#ekran-görüntüleme-grubu)
    - [Dikey Grup](#dikey-grup)
    - [Yatay Kontrol Grubu](#yatay-kontrol-grubu)
    - [Tetik Grubu:](#tetik-grubu)
    - [Osiloskopta Yapılacak Ölçmeler:](#osiloskopta-yapılacak-ölçmeler)
    - [Alternatif akım ve Periyodik Sinyaller](#alternatif-akım-ve-periyodik-sinyaller)
    - [DENEYİN YAPILIŞI:](#deneyi̇n-yapilişi-2)
  - [DENEY No 5: Direnç Renk Kodları, Deney Tahtası, CADET Deney Seti ve Multimetre Kullanımı](#deney-no-5-direnç-renk-kodları-deney-tahtası-cadet-deney-seti-ve-multimetre-kullanımı)
    - [GİRİŞ](#gi̇ri̇ş)
    - [Deney Tahtası (Breadboard)](#deney-tahtası-breadboard)
    - [CADET Analog-Dijital Devre Eğitim Seti](#cadet-analog-dijital-devre-eğitim-seti)
    - [Dijital Multimetre](#dijital-multimetre)
    - [Multimetre ile direnç ölçmek](#multimetre-ile-direnç-ölçmek)
    - [Multimetre ile voltaj ölçümü](#multimetre-ile-voltaj-ölçümü)
    - [Multimetre ile akım ölçmek](#multimetre-ile-akım-ölçmek)
    - [Deney öncesi çalışma:](#deney-öncesi-çalışma-1)
    - [Deney Çalışmaları:](#deney-çalışmaları)
  - [DENEY NO: 6.1 Elektromıknatısın demiri çekmesi ve çekme kuvvetinin hesabı](#deney-no-61-elektromıknatısın-demiri-çekmesi-ve-çekme-kuvvetinin-hesabı)
    - [6.1. DENEY HAKKINDA TEORİK BİLGİ](#61-deney-hakkinda-teori̇k-bi̇lgi̇)
    - [6.1.1. Deneyin Bağlantı Şeması](#611-deneyin-bağlantı-şeması)
    - [6.1.2. Deneyin Yapılışı](#612-deneyin-yapılışı)
    - [6.1.3. Deney ile İlgili Sorular](#613-deney-ile-i̇lgili-sorular)
  - [DENEY NO: 6.2 Elektromanyetik İndüksiyon](#deney-no-62-elektromanyetik-i̇ndüksiyon)
    - [6.2. DENEY HAKKINDA TEORİK BİLGİ](#62-deney-hakkinda-teori̇k-bi̇lgi̇)
    - [6.2.1. Deneye Ait Bağlantı Şemaları](#621-deneye-ait-bağlantı-şemaları)
    - [6.2.2. Deneyin Yapılışı](#622-deneyin-yapılışı)
    - [6.2.3. Deney ile İlgili Sorular](#623-deney-ile-i̇lgili-sorular)
...
*   **Özdirenç (`ρ`):** Bir malzemenin elektrik akımına karşı gösterdiği direncin maddenin yapısına bağlı olarak değişen özelliğidir.
*   **Ohm Kanunu:** Bir devredeki gerilimin (`V`), akım (`I`) ve direnç (`R`) arasındaki ilişkiyi ifade eden temel kanun ($V = I \times R$).
*   **Ampermetre:** Elektrik devresindeki akım şiddetini ölçmek için devreye seri bağlanan, iç direnci çok düşük olan ölçü aleti.
...
>[!infobox|center]
>![img-1.jpeg|400](img-1.jpeg)
>Şekil 1.1: Çeşitli Elektrik Devresi Bileşenleri

*   **Güç Kaynağı:** Herhangi bir enerjiyi elektrik enerjisine dönüştüren sistemlere elektrik enerji kaynağı denir. `Doğru akım kaynakları` (akümülatör, pil, dinamo) ve `alternatif akım kaynakları` (şehir şebekesi, jeneratör, alternatör ve sinyal kaynağı) bulunur.
*   **Anahtarlar:** Elektrik akımının kontrolünü sağlarlar ve devreye seri bağlanırlar. Açık konumda akım akmazken, kapalı konumda akım akar.
...
>[!infobox|center]
>![img-4.jpeg|400](img-4.jpeg)
>Şekil 1.4 Doğru akım deney devresi

1.  Deney devresi Şekil 1.4'de verilmiştir. Uygun devre elemanları seçilir. Verilen bileşenlerin uygunluğu incelenir. Uygun kablolar kullanılarak devre bağlantısı gerçekleştirilir. Güç kaynağını devreye bağlamadan önce (boşta iken) çalışmasını kontrol ediniz. Reostayı yüksek değere getiriniz.
...
Burada;
*   `l`: uzunluk (m)
*   `ρ`: malzemenin cinsine bağlı olan özdirenç katsayısı (Ωmm²/m)
*   `S`: Kesit alanı (mm²)
...
2.  Yukarıda verilen formüle göre tel kesitini hesaplayınız.
...
2.  Her bir tel ve kablonun direnç değerlerini Şekil 1.6'de gösterildiği gibi ohmmetre ile ölçerek not ediniz.
3.  Ölçtüğünüz değerler ve iletken teller için yorum yapınız. Sonucu özetle ifade ediniz.
...
>[!infobox|center]
>![img-10.jpeg|400](img-10.jpeg)
>Şekil 1.7.b Voltmetre Teşkili

#### Deneyin Yapılışı
1.  Şekil 1.8.a'daki devre için `0-12 V DC` kaynak ve `0,6-1,2 A` değerlerini ölçebilecek Ampermetre, yük olarak bu değerlere uygun, wattlı dirençleri direnç kutusundan seçilecektir.
2.  Şekil 1.8.a'daki devreyi kurunuz. Devreye güç vermeden önce aşağıdaki uyarıları dikkate alınız:
...
3.  Şekil 1.8.b'deki devre için kademeli bir voltmetre seçiniz. Yine direnç kutusundan direnç seçiniz.
4.  Şekil 1.8.b'deki devreyi kurunuz. Devreye güç vermeden önce aşağıdaki uyarıları dikkate alınız:
...
>[!infobox|center]
>![img-11.jpeg|400](img-11.jpeg)
>Şekil 1.8.a Ampermetre ile akım ölçme

>[!infobox|center]
>![img-12.jpeg|400](img-12.jpeg)
...
>[!infobox|center]
>![img-13.jpeg|400](img-13.jpeg)
>Şekil 1.9.a AC Varyak Devresi

#### DENEYİN YAPILIŞI:
1.  Şekil ile verilen deney bağlantı şemasını uygun elemanlar ile kurunuz.
...
>[!infobox|center]
>![img-14.jpeg|400](img-14.jpeg)
>Şekil 1.10: Çeşitli sigorta tipleri

**Sigorta Tipleri (Kullanım Yerlerine Göre):**
1.  **Cam Tipi Sigortalar:** Elektrik cihazları ve elektronik devrelerde kullanılır.
2.  **Buşon Tipi Sigortalar:** Elektrik tesisatlarının korunması amacıyla alçak gerilimli şebekelerde kullanılır.
3.  **Otomatik Sigortalar:** Üzerinden geçen akım sınır değeri aştığında içerideki bimetal bükülerek sigortayı attırır.
4.  **Bıçaklı Tip Sigortalar:** Büyük akımlarda kullanılırlar, sanayide motorları ve güçlü alıcıları korumak için tasarlanmıştır. Yüksek akımlarda ve endüstriyel uygulamalarda güvenilir koruma sağlarlar.
5.  **Yüksek Gerilim Sigortaları:** Yüksek gerilimli sistemlerde koruma sağlamak üzere özel olarak tasarlanmıştır. Genellikle trafo merkezleri ve enerji dağıtım hatlarında kullanılırlar.

**Devreyi Açma Zamanlarına Göre Sigortalar:** Normal, Gecikmeli, Hızlı ve Çok Hızlı özellikli olabilir.

>[!infobox|center]
>![img-15.jpeg|400](img-15.jpeg)
...
Genel ifadesi:
$$
\Delta Q=\sqrt{\left(\frac{d Q}{d x} \Delta x\right)^{2}+\left(\frac{d Q}{d y} \Delta y\right)^{2}+\left(\frac{d Q}{d z} \Delta z\right)^{2} \ldots}
$$
Basit işlemler için:
*   Toplama - Çıkarmada: `ΔQ ≈ Δx + Δy`
*   Çarpma - Bölmede: `ΔQ ≈ Q((Δx / x) + (Δy / y))`
...
11. İki Ampermetre ile ölçtüğünüz değerin toplamını hata hesabı ile birlikte yapınız.
...
4.  İki ölçü aleti ile ölçtüğünüz değeri kullanarak dirençte harcanan elektrik gücünü ve birleşik hata hesabını yaparak güç değerini ifade edin.
5.  Elde ettiğiniz sonucu, Güç kaynağının gösterdiği değerler ile karşılaştırın ve yorumlayın.

>[!infobox|center]
>![img-18.jpeg|400](img-18.jpeg)
...
1.  **Düşük direnç:** Değeri `1 Ω`'a eşit veya daha küçük olan dirençler (örn: makinelerin armatür sargıları, ampermetre şöntleri).
2.  **Orta direnç:** Değerleri `1 Ω` ile `100 kΩ` arasında değişen dirençler (örn: elektronik devrelerde kullanılan dirençler).
3.  **Yüksek direnç:** `100 kΩ`'ın üzerindeki değerlere sahip dirençler.
...
$$
\frac{R_{s}}{R_{1}}=\frac{L_{s}}{L_{1}}
$$
Bu durumda bilinmeyen direnç değeri:
$$
R_{x}=\frac{L_{s}}{L_{1}} \cdot R_{s}
$$
...
4.  Şerit metre ile `L₁` Ve `L₂` uzunluklarını ölçünüz.
5.  Ölçtüğünüz değerleri verilen formülde yerine koyarak bilinmeyen direnç değerini hesaplayın. Şerit metrede hata miktarını `0,5 mm` alarak direncin toplam hatasını hesaplayın. Direnç ölçümünün sonucunu ifade edin.
...
>[!infobox|center]
>![img-21.jpeg|400](img-21.jpeg)
>Şekil 2: Alternatif akımda alıcıların akım ve gerilim vektörleri ile faz farkı

*   **Endüktif reaktans (`XL`):** Alternatif akımda saf bobinin oluşturduğu dirence denir. Birimi `Ω`'dur. Tamamen endüktif bir yükte, AC'de, devre gerilimi ile akımı arasında `90°` fark meydana gelir (Şekil 3).

>[!infobox|center]
>![img-22.jpeg|400](img-22.jpeg)
...
*   İç direnci `100 Ω` olan bir bobinin öz indüktans katsayısı `L = 1 H`'dir. Bu bobine `50 Hz`, `100 V` uygulandığında devreden geçecek akımı ve oluşacak faz farkını hesaplayın.
...
>[!infobox|center]
>![img-30.jpeg|400](img-30.jpeg)

1.  Şekil'deki devre bileşenleri seçilir. İlk olarak sadece omik yükler (flamanlı lambalar) için devre kurulur. Varyak gerilimi sıfırdan itibaren artırılarak `150 Volt` ve `220 Volt` değerleri için akım, gerilim ve güç değerleri okunarak Tablo 1'e kaydedilir. (Kademelere ait çarpan değerlerine dikkat edin)
...
4.  Ölçülen değerlerden Cosφ değeri hesaplanır.
5.  Şekil'deki devreye göre bu defa 1 ve 3. maddeler için kullanılan bobin ve lambalar bağlanır. Varyak `220 V` iken ölçü aletlerindeki değerler okunarak Tablo 2'ye kaydedilir.
6.  Ölçülen değerlerden Cosφ değerini hesaplayın.
...
>[!infobox|center]
>![img-31.jpeg|400](img-31.jpeg)

1.  Şekil'deki devre kurulur. Varyak gerilimi sıfırdan itibaren artırılarak `150 Volt` ve `220 Volt` değerleri için akım gerilim ve güç değerleri okunarak Tablo 3'e kaydedilir.
...
1.  Aşağıda verilen Şekil'deki devre kurulur. Varyak gerilimi sıfırdan itibaren `220 Volt` değerlerine kadar artırılır. Sayaç dik ve yatık konumlardaki hareketi gözlenir.
2.  Sayaç diskinin `t` dakika süresinde dönme sayısı `n` olursa sayacın etiketinde yazılı devir adedi/kWh=`k` değerine göre sayaçtan geçen enerji (kWh olarak) `W = P · t = (n/k) · 60` olarak hesaplanabilir. Deneyde aldığınız alıcının çalışma süresi ve sayaç diskinin dönme adedi değerleri ile sarf edilen enerjiyi hesaplayınız. Sayacın kaydettiği değerle karşılaştırınız.
3.  Sayaç ile güç ölçümü nasıl yapılabilir, tartışınız.

>[!infobox|center]
>![img-32.jpeg|400](img-32.jpeg)
...
*   **Görüntü ekranı:** Genellikle `8x10 cm`'lik bir ızgaraya yerleştirilmiştir. Osiloskop, katot ışını tüpünün (CRT) içindeki fosfor kaplama boyunca bir elektron ışını hareket ettirerek girişine gelen sinyalin grafiğini çizer.
*   **Yoğunluk kontrol düğmesi:** Işığın parlaklığını ayarlamak ve bulanıklığı gidermek için kullanılır.
...
*   **"AC / GND / DC" etiketli giriş kuplaj anahtarı:** O kanalın ekranının kuplaj modunu seçer.
    ...
    *   **GND:** `0 V` referans seviyesini gösterir.
...
*   **Bölme başına saniye düğmesi:** Zaman tabanı (yatay) ölçeğini ayarlar. Saniye, milisaniye ve mikrosaniye olarak işaretlenir. _Not: Her iki kanal için yalnızca bir yatay ölçek vardır._
...
*   **Genlik Ölçümü (dikeyde voltaj):**
    Sinyal olarak `2 V` doğru gerilim uygulandığında Şekil 2.a'de gösterilen sinyal görüntüsü elde edilecektir. Sinüsoydal bir sinyal uygulandığında (Şekil 2.b) sıfırdan itibaren dikey olarak kaç çizgi ve kaç ince iz (bu bölümler çentik işaretleriyle `1/5`'e (`0,2`) bölünmüştür.) olduğu sayılır. Bu sayı kanalın volt / div çarpanı ile çarpılarak sinyalin tepe değeri elde edilir.
...
*   **Sıklık (Frekans):**
    Sinyalin periyodunu (`T`) ölçün. `F = 1 / T` kullanarak frekansı (`f`) hesaplayın. (`f = 1 / 20 ms = 50 Hz`)

>[!infobox|center]
>![img-34.jpeg|400](img-34.jpeg)
...
*   `V(t)`, **Anlık Değer:** Alternatif akım ve gerilimin herhangi bir andaki değeridir. `v₁(t) = Vm · Sin(wt + θ)`
*   `Vm`, **Maksimum (Tepe) Değer:** Alternatif akımın anlık değerleri içindeki en büyük değeridir.
*   `Vort`, **Ortalama Değer:** Bir periyottaki ani değerlerin ortalamasıdır. Ortalama değer, sinyalin doğru akım değeridir. Saf alternatif akımın ortalama değeri sıfırdır.
    *   "`Vortalama = (1/T) ∫(-T/2)ᵗ/² v(t) dt`"
    *   Doğru akım ölçü aletleri sinyalin DC bileşenini ölçerler.

>[!infobox|center]
>![img-35.jpeg|400](img-35.jpeg)
>Şekil 3: a. Sinüsoydal sinyalin karakteristik değerleri b. iki sinyalin faz farkı

*   `Veff.` (`V`), **Etkin (Efektif) Değer (RMS):** Alternatif akımın bir dirençte, doğru akımla eş değerde etki yaptığı değerine etkin veya efektif değer denir. Ülkemizdeki elektrik şebekesinin efektif gerilim değeri `220 volt`tur. AC ampermetre ve voltmetre, akımın ve gerilimin etkin değerini (RMS) gösterirler. Bir işaretin karesinin bir periyot boyunca alınan ortalamasının karekökü olarak tanımlanır.
    *   "`Veffektif = √( (1/T) ∫(-T/2)ᵗ/² v(t)² dt )`"
    *   Tam sinüs dalga şekli için: `Veff = (1/√2) * Vm = 0,707 Vm`
...
1.  Aşağıda verilen deney şemasına göre bağlantıyı gerçekleştiriniz.

>[!infobox|center]
>![img-36.jpeg|400](img-36.jpeg)
...
*   Osiloskopun ayarlarını kullanarak ekrandaki sinyal görüntüsünü sabit ve `1-2` periyotu kapsayacak şekilde elde etmeye çalışınız. Daha sonra, bu işarete ait büyüklükleri (sinyalin maksimum gerilimi, tepeden tepeye değerini, ortalama değerini, sinyalin periyodunu ölçünüz, frekansını hesaplayınız) osiloskop ekranından ve voltmetreden okuyarak kaydediniz.
*   Osiloskopta elde ettiğiniz görüntüyü (ek graikte size verilecek) aşağıdaki milimetrik grafik ekran (1. Grafik) üzerine yaklaşık olarak çiziniz. Verilere bakarak her bir kanalın tepe değer ve periyot değerini ölçünüz. Bu değerlerden yaralanarak etkin değer ve frekans değerleri hesaplayın ve kaydedin.

>[!infobox|center]
>![img-37.jpeg|400](img-37.jpeg)
>1. Grafik

>[!infobox|center]
>![img-38.jpeg|400](img-38.jpeg)
>2. Grafik
...
>[!infobox|center]
>![img-39.jpeg|400](img-39.jpeg)
>Şekil 6: Deney şeması
>Şekil 7: Yarım dalga doğrultucu

*   Osiloskobun ayarlarını kullanarak ekrandaki sinyal görüntüsünü sabit ve `1-2` periyot olacak şekilde elde etmeye çalışınız. Sonra, her iki işarete ait büyüklükleri (sinyalin tepeden tepeye değerini ve sinyalin periyodunu ölçünüz, frekansını hesaplayınız) osiloskop ekranından okuyarak kaydediniz.
*   Osiloskopta elde ettiğiniz görüntüyü (ekte size verilecek) aşağıdaki milimetrik grafik ekran (2. Grafik) üzerine yaklaşık olarak çiziniz. Verilere bakarak her bir kanalın tepe değer ve periyot değerini ölçünüz. Bu değerlerden yararlanarak etkin değer ve frekans değerleri hesaplayın ve kaydedin.
...
3.  Sekil 7'deki devreyi kurunuz. Benzer şekilde osiloskobun iki kanalını ve voltmetreyi de devreye bağlayınız. Osilatör frekansını `1-10 kHz` aralığında ve gerilimini `5 V` olacak şekilde ayarlayınız.
...
>[!infobox|center]
>![img-41.jpeg|250](img-41.jpeg)
>Osiloskop Probları

>[!infobox|center]
>![img-42.jpeg|250](img-42.jpeg)
...
*   **Özellikleri:** Genliği ve frekansı ayarlanabilen sinüs, üçgen ve kare dalga sinyal jeneratörü, buton kontrollü `5V TTL` kare sinyali, `+5 V` sabit, `±0-12 V` ayarlı DC gerilim kaynağı, bağımsız `12 V AC` trafo çıkışı, ayarlı dirençler (pot), BNC soketi ile osiloskop bağlantısı, anahtarlar ve gösterge ledleri gibi yardımcı ekipmanları içerir.

>[!infobox|center]
>![img-45.jpeg|400](img-45.jpeg)
...
*   **Fonksiyonlar:** `LCD` ekranı sayesinde kolayca okunabilen değerler sunar. Bazı multimetrelerle frekans, transistör kazancı, sıcaklık ölçümü yapılabilir ve diyot, transistör kontrolü sağlanabilir.
*   **Kullanım:** Cihazın ortasındaki konum komütatörü ile akım, gerilim, direnç, AC-DC vb. ölçüm modları seçilir.

>[!infobox|center]
>![img-46.jpeg|400](img-46.jpeg)
...
1.  Size verilen direnç kutusundan renk kodlarına bakarak Şekilde verilen dirençleri seçiniz veya onların yerine rastgele dirençler seçiniz. `Rab` değerini hesaplayınız. Her birisini ölçerek tolerans bölgelerinde olduğunu kontrol ediniz. Devreyi breadboard üzerine kurunuz ve `a-b` arasındaki eşdeğer direnci ölçünüz. Ölçtüğünüz ve hesapladığınız değerleri tabloya yazınız. Dirençlerin renk kodu ile verilen toleransı ile ölçtüğünüz değerlerin toleransını karşılaştırınız. Sonuçları yorumlayınız.

>[!infobox|center]
>![img-49.jpeg|400](img-49.jpeg)
...
9.  CADET üzerindeki mini hoparlör, trafo çıkışları (`AC 12V - 50 Hz`), anahtar ve ikili kod led göstergelerin nasıl kullanılabileceğini aranızda konuşun. CADET'in üzerindeki bileşenler kullanarak denemeler yapın.
...
Burada;
*   `B`: Manyetik akı yoğunluğu (`Wb/m²` veya Tesla)
*   `μ`: Manyetik geçirgenlik (permabilite)
*   `μ₀`: Boşluğun manyetik geçirgenliği (`12,56.10⁻⁷ H/m`)
*   `μᵣ`: Bağıl manyetik geçirgenlik
...
Burada;
*   `F`: Çekme kuvveti (`kg` veya Newton)
*   `S`: Elektromıknatısın çekme yüzeyi (`cm²` veya `m²`)
*   `B`: Akı yoğunluğu ya da Manyetik indüksiyon (`Gauss` veya Tesla = `V.s/m²`)

### 6.1.1. Deneyin Bağlantı Şeması

>[!infobox|center]
>![img-51.jpeg|400](img-51.jpeg)
...
Burada;
*   `c`: yay sabiti (`N/m`)
*   `Δl`: gerilme mesafesi (`m`)
*   `S`: elektromıknatısın yüzey alanı (`m²`)
...
2.  Sarım sayısını arttırmak ve bobinin içine demir nüve eklemek manyetik alanı niçin kuvvetlendiriyor, açıklayınız.
...
*   `N`: Bobinin sarım sayısı
*   `Φ`: Manyetik akı (bobinin içinden geçen toplam akı) (`Wb`)
*   `t`: Zaman (`s`)
...
Burada;
*   `V₁`: Birinci bobine uygulanan gerilim (`V`)
*   `V₂`: İkinci bobinde indüklenen gerilim (`V`)
*   `f`: Uygulanan gerilimin frekansı (`Hz`)
*   `Φm`: Manyetik akının maksimum değeri
*   `N₁`: Birinci bobinin sarım sayısı
*   `N₂`: İkinci bobinin sarım sayısı

### 6.2.1. Deneye Ait Bağlantı Şemaları

>[!infobox|center]
>![img-56.jpeg|400](img-56.jpeg)
>Şekil 6.6: Çoklu çıkış sarımlarına sahip transformatör

### 6.2.2. Deneyin Yapılışı

1.  Şekil 6.4'teki gibi bobinin uçlarını ölçü aletine bağladıktan sonra demir parçasını bobinin içine sokup çıkartarak ölçü aletindeki değerin değişimini gözlemleyiniz.
2.  Şekil 6.6'da gösterilen sargılara sahip transformatörün giriş sargısına doğru gerilim uygulayınız. Çıkış sargılarında gerilim olup olmadığını ölçü aleti yardımıyla gözleyiniz.
...
5.  Şekil 6.6'daki transformatörün giriş uçları arasına Tablo 6.2'de verilen değerlerdeki alternatif gerilimleri uygulayarak çıkış sargılarındaki gerilimleri kaydediniz. 3. Adımda hesapladığınız gerilim değerleriyle karşılaştırınız. Fark varsa sebebini yorumlayınız.
...
6.  Primer (birincil) sarım sayısı `N₁ = 150` sarım, sekonder (ikincil) sarım sayısı `N₂ = 300` sarım, demir nüve kesiti `10 cm²` olan bir transformatörde primer gerilimi `110 V`, sekonder akımı `10 A`'dır. Frekans `50 Hz` için sekonder gerilimini, primer akımını ve demir nüvedeki manyetik indüksiyonu bulunuz (verim `%100` alınacaktır, `μᵣ = 3`).

# Temel Formüller ve Hızlı Bilgiler
>[!example]+ **Temel Elektrik Formülleri**
>---
>
>**Ohm Kanunu:**
> *Gerilim*, *Akım* ve *Direnç* arasındaki ilişkiyi gösterir.
> `V = I * R`
> * `V`: Gerilim (Volt)
> * `I`: Akım (Amper)
> * `R`: Direnç (Ohm)
>
>**Elektriksel Güç:**
> Bir devrede harcanan veya üretilen gücü ifade eder.
> `P = V * I`
> * `P`: Güç (Watt)
>
>**Direnç Hesaplaması (İletken Boyutlarına Göre):**
> Bir malzemenin kendi iç direncini, uzunluk ve kesit alanına göre belirler.
> `R = ρ * (l / S)`
> * `ρ`: Özdirenç
> * `l`: Uzunluk
> * `S`: Kesit Alanı
...
> `P = V * I * Cosφ` (*Aktif Güç*, Watt)
> `Q = V * I * Sinφ` (*Reaktif Güç*, Var)
> `S = V * I` (*Görünür Güç*, VA)
> `S = √(P² + Q²)` (Güç Üçgeni)
> * `φ`: Gerilim ile akım arasındaki faz farkı açısı
>
>**AC Gerilim ve Akım Değerleri:**
> *Periyodik sinyallerde temel ölçümler.*
> `V(t) = Vm * Sinθ` (Ani gerilim değeri)
> `I(t) = Im * Sinθ` (Ani akım değeri)
> `V_etkin = Vm / √2` (Etkin gerilim değeri, RMS)
> `I_etkin = Im / √2` (Etkin akım değeri, RMS)
>
>---
>
>**Hata Hesaplaması (Bağıl Hata):**
> Ölçümdeki hata oranını yüzde olarak ifade eder.
> `%ε = (ΔV / V) * 100`
> * `ΔV`: Mutlak Hata
>
>**Hataların Bileşkesi (Çarpma - Bölme):**
> Çoklu değişkenlere bağlı sonuçların hata hesabı.
> `ΔQ ≈ Q * ((Δx / x) + (Δy / y))`
>
>---
>
>**Elektromanyetik İndüksiyon (Faraday Yasası):**
> Bir bobinde indüklenen gerilimi manyetik akı değişimine bağlar.
> `E = -N * (dΦ / dt)`
...
> İçinden akım geçen iletken veya bobinde oluşan manyetik alanı hesaplar.
> `B = μ * H = μ₀ * μᵣ * (N * I / l)`
> * `B`: Manyetik Akı Yoğunluğu (Tesla)
> * `H`: Manyetik Alan Şiddeti
> * `μ₀`: Boşluğun Manyetik Geçirgenliği
> * `μᵣ`: Bağıl Manyetik Geçirgenlik
> * `l`: Manyetik Yol Uzunluğu
>
>**Transformatörlerde Gerilim Oranı:**
> Sarım sayıları ile gerilimler arasındaki ilişki.
> `V₁ / V₂ = N₁ / N₂`
>
>---
>
>**Elektrik Enerjisi Tüketimi:**
> Belirli bir güçteki alıcının belirli bir sürede harcadığı iş.
> `E = P * t` (Wh veya kWh)
> * `t`: Zaman (saat)
